...
function generateKeys(keyByte){
 ...
 return keys;
        ...
        '''
        js_code = execjs.compile(js_string)#.call("strEnc",data,self.first_key,self.second_key,self.third_key)
        encrypted_data = js_code.call("strEnc",data,self.first_key,self.second_key,self.third_key)
        return encrypted_data

if __name__ == "__main__":
    info = StudentVerification("21904096","Aa136549")
    info.get_first_LT_and_JSESSIONCAS()
    print(info.get_ticket_and_CASTGC())